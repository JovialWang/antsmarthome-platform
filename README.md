...
<img src="https://github.com/JovialWang/resource/blob/master/IMG_0A4740A37491-1.jpeg?raw=true" height=600/>
...
如果插件启动出现问题需要重置，可以手工删除Homebridge目录下accessories中cachedAccessories文件，再进入antsmarthome-platform文件夹删除accessory_map.json文件后重启homebridge。
